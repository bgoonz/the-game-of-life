var ui = (function () {
  ...
  function setUpEventHandlers() {
    ...
    $("#save_button").click(
      supports_localstorage
        ...
        : function () {
            alert(
              "Your browser does not support localStorage. Please use the latest Firefox or Chrome version."
            );
          }
    );
    ...
    $("#save_dialog").dialog({
      ...
      open: function () {
        ...
        $(this)
          .find(".init_img")
          .prop("src", pics.initial)
          .end()
          .find(".current_img")
          .prop("src", pics.current)
          .end()
          .find(".title")
          .val(loadedGame.title || "Game #" + store.games.length)
          .end()
          .find(".descr")
          .val(loadedGame.description || "");
      },
      buttons: {
        Save: function () {
  ...
  function getFullStats(e) {
    return [
      ...
      "AbsoluteCell: " + grid.getAbsoluteCellFromPosition(e.clientX, e.clientY),
    ].join("<br>");
  }
